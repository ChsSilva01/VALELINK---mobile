...
if (isset($_GET['cod_vagas'])) {
    ...
    $res = $query->fetchAll(PDO::FETCH_ASSOC);
        ...
        $tempo_de_contrato = $res[$i]['tempo_contrato_vagas'];
            ...
            if(count($res) > 0){
                    $result = json_encode(array('success'=>true, 'nome_empresa'=>$nome_empresa, 'foto_empresa'=>$foto_empresa, 'salario_vagas'=>$salario_vagas, 'carga_horaria_vagas'=>$carga_horaria_vagas, 'tempo_contrato_vagas'=>$tempo_contrato_vagas));
